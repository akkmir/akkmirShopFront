...
import {
  ...
  setDiliverytype,
  setAddress,
} from "../../appStore/reducers/makeOrderReducer";
...
const DiliveryCoast2 = css.DiliveryCoast2;
...
const MakeOrder = () => {
  ...
  function orderController() {
    if (number) {
      ...
      setNewUserCabinetBody(
        `?number=${number}&auth=sms&name=${name}&email=${email}&car=${model}`
      );
      ...
      dispatch(
        setMessageContent({
          ...
          message:
            "Пожалуйста, заполните обязательные поля и попробуйте оформить заказ повторно",
          type: "error",
        })
      );
  ...
  return (
    <React.Fragment>
      ...
      <MakeOrderWrapper style={{ overflow: "hidden" }}>
        ...
        <Form>
          <h5 style={{ fontSize: "18px", marginBottom: "12px" }}>
            Контактная информация
          </h5>
          <p style={{ fontSize: "13px", lineHeight: "24px" }}>
            Уже регистрировались на сайте? Войдите и вам не придется заполнять
            форму снова, а заказ сохраниться в личном кабинете
          </p>
          ...
          <Input
            params={{ width: 300 }}
            type={"text"}
            placeholder={emailFromAuth ? emailFromAuth : "example@mail.ru"}
            inputCss={{
              border: "none",
              borderRight: email
                ? "6px solid rgb(43, 198, 49)"
          ...
          >
            Вводите адрес, включая город, после чего нажмите кнопку проверки
            адреса
          </span>
            ...
            action={() => {
              dispatch(
                setMessageContent({
                  ...
                  message:
                    "Данный раздел необходимо согласовать и добавить в общий макет для реализации",
                  type: "error",
                })
              );
              dispatch(setMessageShow(true));
        ...
        <OrderData>
          ...
          <OrderItems>
            <Items>
              ...
              <DiliveryCoast>
                <div
                  style={{ display: "flex", alignItems: " center", gap: 49 }}
                >
                  <img src={truck} alt="" />
            ...
            <OrderForm>
              ...
              <div style={{ dislplay: "flex", flexDirection: "row" }}>
              ...
              <h6 style={{ fontSize: "18px", marginBottom: "10px" }}>
                {isDiscount
                  ? (Number(summaryCoast) - summaryCoast * 0.05).toFixed(0)
                  : summaryCoast}{" "}
                RUB
              </h6>
              ...
              >
                Цена с учетом скидки при сдаче вашего аккумулятора аналогичных
                размеров
              </p>
                    ...
                    number &&
                      dispatch(
                        setMessageContent({
                          ...
                          message:
                            "Мы создадим вам учетную запись в личном кабинете, чтобы при дальнейших покупках вы не вводили снова контактные данные",
                          type: "success",
                          windowHeight: "330px",
                          children: (
                            <Button
                  ...
                  false &&
                    dispatch(
                      setMessageContent({
                        ...
                        message:
                          'Функция "Купить в один клик" находится в стадии формирования тз и скоро будет реализована',
                        type: "error",
                      })
                    );
              ...
              <p
                style={{ color: "grey", lineHeight: "18px", fontSize: "13px" }}
              >
